...
public class FishingActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        if (Integer.parseInt(flagMaker.hMap.get("Fishing2"))==1){

            is_good.setText("낚시하기 좋은 날씨"); // 서핑 플래그
            title.setTextColor(Color.parseColor("#00D1FF"));
            is_good.setTextColor(Color.parseColor("#00D1FF"));
            img.setImageResource(R.drawable.fish_b);
        }
        else{
            is_good.setText("낚시하기 좋지 않은 날씨"); // 러닝 플래그
