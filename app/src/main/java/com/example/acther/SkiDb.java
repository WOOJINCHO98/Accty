...
class SkiDb extends SQLiteOpenHelper{
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        ...
        sqLiteDatabase.execSQL("INSERT INTO skiTable VALUES('"+ "알펜시아리조트" + "',"+skiLocationX[0]+","+skiLocationY[0]+"," +
                "'"+"강원 평창군 대관령면 용산리 425"+"','"+"033-339-0000"+"','"+"http://place.map.kakao.com/26977193"+"')");
