...
public class RunningActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        ozone.setText(flagMaker.hMap.get("O3Grade")); // 평균풍속
