...
public class GlidingActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_gliding);
        ...
        if (Integer.parseInt(flagMaker.hMap.get("Hiking"))==1){
            ...
            img.setImageResource(R.drawable.glide_b);
        }
        else{
            is_good.setText("글라이딩하기 좋지 않은 날씨"); // 러닝 플래그
            title.setTextColor(Color.parseColor("#FF3203"));
            is_good.setTextColor(Color.parseColor("#FF3203"));
            img.setImageResource(R.drawable.glide_o);
